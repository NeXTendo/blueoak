      ...
      <div className="w-full max-w-sm space-y-12 relative z-10">
        ...
        <div className="space-y-4 text-center animate-in fade-in slide-in-from-bottom-4 duration-1000">
          <Link to="/" className="flex justify-center group">
            <div className="h-5 w-5 rounded-full bg-primary group-hover:scale-125 transition-transform duration-500 shadow-2xl shadow-primary/20" />
          </Link>
          <div className="space-y-1">
            <h1 className="text-4xl font-black uppercase tracking-tighter text-primary leading-tight">
              {title}
            </h1>
